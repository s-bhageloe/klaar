       ...
       <table class="table table-striped" id="overzicht">
           ...
           <tbody></tbody>
               ...
               <tr>
                   ...
                   <td class="Edit">
                       <a class="btn btn-primary mr-2 btn-sm" href="./school/editSchool.php?id=<?php echo $user['schoolID']; ?>">Edit</a>
                   </td>      
                   <td class="Delete">
               ...
               <?php endforeach; ?>               
                    <td class="Create">
                        <a class="btn btn-success mr-2 btn-sm rounded-pill" href="./school/createSchool.php?id=">Create</a>
                    </td>
                    <td class="index">
